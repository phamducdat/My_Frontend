      ...
      <List>
        ...
        <div>
          <ListItem button onClick={() => handleListClick(15)}>
            ...
            <ListItemText primary="Quản lý vận chuyển bưu kiện"/>
          ...
          <Collapse in={openCollapse[15]} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem
                ...
                component={Link}
                to={process.env.PUBLIC_URL + "/shiporder/create"}
              >
                <ListItemIcon>
                  <StarBorder/>
                </ListItemIcon>
                <ListItemText primary="Tạo mới đơn hàng"/>
              </ListItem>
              ...
              <ListItem
                ...
                className={classes.nested}
                component={Link}
                to={process.env.PUBLIC_URL + "/shiporder/list"}
              >
                <ListItemIcon>
                  <StarBorder/>
                </ListItemIcon>
        ...
        <div>
          <ListItem button onClick={() => handleListClick(12)}>
            ...
            <ListItemText primary="Shippingorder"/>
          ...
          <Collapse in={openCollapse[12]} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem
                ...
                className={classes.nested}
                component={Link}
                to={process.env.PUBLIC_URL + "/shippingOrder/create"}
              >
                <ListItemIcon>
                  <StarBorder/>
                </ListItemIcon>
              ...
              <ListItem
                ...
                className={classes.nested}
                component={Link}
                to={process.env.PUBLIC_URL + "/shippingOrder/lists"}
              >
                <ListItemIcon>
                  <StarBorder/>
                </ListItemIcon>
        ...
        <div>
          <ListItem button onClick={() => handleListClick(2)}>
            ...
            <ListItemText primary="Quản lý sinh viên"/>
          ...
          <Collapse in={openCollapse[2]} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem
                ...
                className={classes.nested}
                component={Link}
                to={process.env.PUBLIC_URL +"/student/create" }
              >
                <ListItemIcon>
                  <StarBorder/>
                </ListItemIcon>
                <ListItemText primary="Tạo mới sinh viên"/>
              </ListItem>
              ...
              <ListItem
                ...
                className={classes.nested}
                component={Link}
                to={process.env.PUBLIC_URL + "/student/list" }
              >
                <ListItemIcon>
                  <StarBorder/>
                </ListItemIcon>
                <ListItemText primary="Danh sách sinh viên"/>
              </ListItem>
        ...
        <div>
          <ListItem button onClick={() => handleListClick(14)}>
            ...
            <ListItemText primary="Kiểm soát phòng ban"/>
          ...
          <Collapse in={openCollapse[14]} timeout="auto" unmountOnExit>
            <List component="div" disablePadding>
              <ListItem
                ...
                className={classes.nested}
                component={Link}
                to={process.env.PUBLIC_URL + "/department/create"}
              >
                <ListItemIcon>
                  <StarBorder/>
                </ListItemIcon>
                <ListItemText primary="Tạo mới phòng ban"/>
              </ListItem>
